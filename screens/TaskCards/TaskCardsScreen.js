...
class TaskCardsScreen extends Component {
    ...
    // turn the stopwatch on and off without resetting the timer
    toggleStopwatch() {
        this.setState({stopwatchStart: !this.state.stopwatchStart, stopwatchRestart: false});
    }

    // reset the timer on the stopwatch
    resetStopwatch() {
    ...
    retrieveInfo(job_name) {
        ...
        fetch(`${global.route}/taskcardinfo/${reg}/${mode}/${job_name}/${global.user}`)
            ...
            .then(values => {
                ...
                // display the data on the front end by changing the state
                ...
                if (global.user == assigned_to) {
                    ...
                    // get approval, tools, parts, and materials data
    ...
    // get the jobs for the user that is logged in
    getJobs(reg) {
        let data = [];
        ...
        fetch(`${global.route}/jobs/${reg}/${global.user}`)
            ...
            .then(values => {
                ...
                // load all of the job's data in the list
                for (let i = 0; i < values.length; ++i) {
                    ...
                    // if the job has been completed, add a check mark
    ...
    // get the list of parts to remove
    getParts(reg, job_name) {
        ...
        fetch(`${global.route}/parts/${reg}/${job_name}`)
            ...
            .then(values => {
                ...
                // for all parts, create an entry array and append it to the entire list
                for (let i = 0; i < values.length; ++i) {
    ...
    getMaterials(reg, jobName) {
        ...
        fetch(`${global.route}/materials/${reg}/${jobName}`)
            ...
            .then(values => {
                ...
                // initiate an array with technician count, labor, and the first material's title, quantity, and amount
                ...
                if (values != null) {
                    ...
                    // for every material gathered, create a new entry with the title, quantity, and amount
                    for (let i = 0; i < values.length; ++i) {
    ...
    getApproval(jobName) {
        ...
        fetch(`${global.route}/approval/${jobName}`)
            ...
            .then(values => {
                ...
                // "apply" the name and title of whoever approved the taskcard
                this.setState({
    ...
    // get the title of the completed jobs
    ...
    // fill in the list of the materials
    listMaterials(props) {
    ...
    render() {
        ...
        let month = new Date().getMonth() + 1; // off by one so I made up for it.
        let year = new Date().getFullYear();

        // verify that the user wants to submit the taskcard
        ...
        return (
            ...
            <ScrollView style={styles.page}>
                ...
                {/* Add, Edit, Delete, and Refresh buttons */}
                <View>
                    <View>
