...
function TaskCardForm() {
    ...
    /* Get id of employee who approved the task */
    ...
    /* Handle submission by calling postForm */
    const onSubmit = (event) => {
        ...
        // confirm the user wants to submit. If so, call postForm
    ...
    return (
        <KeyboardAwareScrollView style={{height: '90%', backgroundColor: 'white'}}>
            ...
            {/* When the user finishes inputting the job name, retrieve the job's info */}
